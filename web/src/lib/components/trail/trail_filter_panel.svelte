<script lang="ts">
  ...
  import LogSlider from "../base/log_slider.svelte";
  ...
  {#if filterExpanded}
    <div in:slide out:slide>
      ...
      <div class="flex justify-between">
        ...
        <span
          >{formatElevation(filter.elevationGainMax)}{filter.elevationGainMax ==
          filter.elevationGainLimit
            ? "+"
            : ""}</span
        >
      </div>
      ...
      <div class="flex justify-between">
        ...
        <span
          >{formatElevation(filter.elevationLossMax)}{filter.elevationLossMax ==
          filter.elevationLossLimit
            ? "+"
            : ""}</span
        >
      </div>
      ...
      />
      <label for="liked-checkbox" class="ms-2 text-sm">{$_("liked")}</label>
      <hr class="my-4 border-separator" />
